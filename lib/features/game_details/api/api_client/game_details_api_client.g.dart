...
part of 'game_details_api_client.dart';
...
class _GameDetailsApiClient implements GameDetailsApiClient {
  _GameDetailsApiClient(this._dio, {this.baseUrl, this.errorLogger});
